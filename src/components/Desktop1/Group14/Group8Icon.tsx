...
const Group8Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 15 15' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <g filter='url(#filter0_d_195_1458)'>
      <rect
        x={14.9978}
        y={-0.0000953674}
        width={14.9979}
    ...
    <defs>
      ...
      >
        ...
        <feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_195_1458' />
        <feBlend mode='normal' in='SourceGraphic' in2='effect1_dropShadow_195_1458' result='shape' />
      </filter>
    </defs>
  </svg>
);
