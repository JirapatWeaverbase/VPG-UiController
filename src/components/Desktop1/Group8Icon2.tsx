  ...
  <svg preserveAspectRatio='none' viewBox='0 0 15 15' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    ...
    <defs>
      ...
      >
        ...
        <feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_195_1395' />
        <feBlend mode='normal' in='SourceGraphic' in2='effect1_dropShadow_195_1395' result='shape' />
      </filter>
    </defs>
  </svg>
);
const Memo = memo(Group8Icon2);
export { Memo as Group8Icon2 };
